...
wget -q "https://raw.githubusercontent.com/Learningtribes/configuration/${CONFIGURATION_VERSION}/playbooks/sample_vars/passwords.yml" -O passwords-template.yml
