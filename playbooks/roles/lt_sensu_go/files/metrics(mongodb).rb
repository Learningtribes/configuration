  ...
  class Metrics
    ...
    def server_metrics
      ...
      if server_status.key?('wiredTiger')
        ...
        server_metrics['wiredtiger.cache.max_bytes'] = wiredtiger['cache']['maximum bytes configured']
        server_metrics['wiredtiger.cache.used_bytes'] = wiredtiger['cache']['bytes currently in the cache']
        server_metrics['wiredtiger.cache.dirty_bytes'] = wiredtiger['cache']['tracked dirty bytes in the cache']
        server_metrics['wiredtiger.cache.unmodified_pages_evicted'] = wiredtiger['cache']['unmodified pages evicted']
        server_metrics['wiredtiger.cache.modified_pages_evicted'] = wiredtiger['cache']['modified pages evicted']
      end

      # Tcmalloc
      if server_status.key?('tcmalloc')
        tcmalloc = server_status['tcmalloc']
        server_metrics['tcmalloc.generic.virtual_address_used_bytes'] = tcmalloc['generic']['heap_size']
        server_metrics['tcmalloc.generic.virtual_address_allocated_bytes'] = tcmalloc['generic']['current_allocated_bytes']
      end
